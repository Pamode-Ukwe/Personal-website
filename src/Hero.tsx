...
const Hero = () => {
  return (
    <section id='home' className='xl:px-64 sm:px-44 py-12 px-16'>
            ...
            <motion.div className='col-span-1 my-auto font-ibm' initial='hidden' whileInView='visible' viewport={{once: true, amount: 0.2}} transition={{duration: 0.3, ease:'easeOut'}} 
              variants={{hidden: {opacity: 0, x:-50}, visible: {opacity: 1, x:0}}} >
                ...
                <div className='flex justify-between items-center my-6'>
                    <a href="#portfolio"><button className='p-6 sm:my-0 my-2 bg-stone-300 font-bold text-teal-600 rounded-md hover:bg-teal-600 hover:text-pink-300'>
